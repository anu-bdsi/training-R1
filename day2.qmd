...
Time | Content 
:-----------|:-----------------|
10.00-10.10 | [Introduction to tidy data with `tidyverse`](slides/day2-slide1.html){target="_blank"} |
10.10-10.40 | [Data wrangling with `tidyr` and `dplyr`](slides/day2-slide2.html){target="_blank"}  |
10.40-12.00 | [Data visualisation with `ggplot2`](slides/day2-slide3.html){target="_blank"}  |
