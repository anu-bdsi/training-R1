...
Time | Content 
:-----------|:-----------------|
10.00-10.10 | Introduction to tidy data with `tidyverse`
10.10-10.40 | Data wrangling with `tidyr` and `dplyr` |
10.40-12.00 | Starting data visualisation with `ggplot2` |
